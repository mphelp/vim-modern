...
" Matthew's new plugins:
" For additional languages not included previously:
...
" Theme
set t_8f=[38;2;%lu;%lu;%lum " special chars for termguicolors
...
" RESUME PREVIOUS POSITION IN FILE
if has("autocmd")
  au BufReadPost * if line("'\"") > 1 && line("'\"") <= line("$") | exe "normal! g'\"" | endif
endif

" Adding superior search tools
set incsearch
set hlsearch
" Turning off automatic continuation of comments from formatoptions
